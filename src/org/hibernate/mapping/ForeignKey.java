...
public class ForeignKey extends Constraint {
	...
	public String[] deleteTriggerSqlConstraintString(Dialect dialect, String constraintName, String defaultCatalog, String defaultSchema) {
		String[] cols = new String[ getColumnSpan() ];
		String[] refcols = new String[ getColumnSpan() ];
		int i=0;
		Iterator refiter = null;
		...
		String[] result = dialect.getDeleteTrigger(getTable().getQualifiedName(dialect, defaultCatalog, defaultSchema),
				constraintName, cols, referencedTable.getQualifiedName(dialect, defaultCatalog, defaultSchema), refcols, isReferenceToPrimaryKey());
		return 	result;
	}
