 ...
 */
@Entity
@Table(name="transsamefiles")
public class TransSameFiles implements SerializableAdapter
{
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "seq_transsamefiles_gen")
    @GenericGenerator(name = "seq_transsamefiles_gen", strategy = "native", parameters = { @Parameter(name = "sequence", value = "SEQ_TRANSSAMEFILES_ID") })
    private Long id;//主键
