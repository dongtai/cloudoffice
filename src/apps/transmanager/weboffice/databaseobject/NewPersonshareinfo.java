...
@Entity
@Table(name="newpersonshareinfo")
public class NewPersonshareinfo implements SerializableAdapter
{

	// Fields
	@Id
	// @GeneratedValue(strategy = GenerationType.AUTO)
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "seq_newPersonShareinfo_gen")
	@GenericGenerator(name = "seq_newPersonShareinfo_gen", strategy = "native", parameters = { @Parameter(name = "sequence", value = "SEQ_NEW_PERSON_SHAREINFO_ID") })
	...
	/** default constructor */
	public NewPersonshareinfo()
	{
	}

	/** full constructor */
	public NewPersonshareinfo(Users userinfoBySharerUserId,
