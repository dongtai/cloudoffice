 ...
 */
//禁止继承类。
final class ErrorMessageCons extends HashMap<Integer, String>
{
	/**
	 * 禁止实例化类
	 */
	...
	private void initData()
	{
		...
		put(ErrorCons.USER_DEVICE_FORBID_ERROR, "该设备禁止登录,请联系孙爱华：15251664207");
		...
		put(ErrorCons.USER_ORG_NAME_NOT_EXIST,"公司部门名称不存在");
		put(ErrorCons.USER_ORG_NAME_EXIST,"公司部门名称已经存在");
